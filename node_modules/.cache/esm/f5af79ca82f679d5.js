let removeSync,copy,outputFileSync,path,readFileSync,glob,chalk;_82f‍.x([["default",()=>_82f‍.o]]);_82f‍.w("fs-extra",[["removeSync",["removeSync"],function(v){removeSync=v}],["copy",["copy"],function(v){copy=v}],["outputFileSync",["outputFileSync"],function(v){outputFileSync=v}]]);_82f‍.w("path",[["default",["path"],function(v){path=v}]]);_82f‍.w("fs",[["readFileSync",["readFileSync"],function(v){readFileSync=v}]]);_82f‍.w("glob",[["default",["glob"],function(v){glob=v}]]);_82f‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);
...
const _82f‍anonymous=async () => {
  await flattenLiquidFiles();
  await flattenAssets();
  await copyJSONFiles();
};_82f‍.d(_82f‍anonymous);
